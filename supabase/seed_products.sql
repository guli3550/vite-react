...
select
  ...
  '[]'::jsonb, '["S","M","L","XL"]'::jsonb, '["Qora","Oq","Bej"]'::jsonb,
...
select
  ...
  '[]'::jsonb, '["S","M","L"]'::jsonb, '["Qora","Qizil","Pushti"]'::jsonb,
...
select
  ...
  '[]'::jsonb, '["S","M","L","XL"]'::jsonb, '["Pushti","Bej"]'::jsonb,
...
select
  ...
  '[]'::jsonb, '["S","M","L"]'::jsonb, '["Qora","Qizil"]'::jsonb,
