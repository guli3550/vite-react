(() => {
  ...
  css.textContent = `
    @media (max-width:699px){
      ...
      .guli-bottom-nav-modern{left:12px!important;right:12px!important;bottom:calc(8px + var(--safe-bottom, 0px))!important;height:78px!important;padding:5px!important;border-radius:36px!important;background:rgba(255,252,253,.96)!important;backdrop-filter:blur(18px)!important;-webkit-backdrop-filter:blur(18px)!important;box-shadow:0 14px 38px rgba(55,30,38,.16),0 1px 0 rgba(255,255,255,.9) inset!important;border:1px solid rgba(234,221,225,.9)!important}
      .guli-bottom-nav-modern button{height:66px!important;margin:0!important;border-radius:28px!important;position:relative!important;font-size:0!important;overflow:visible!important;display:flex!important;align-items:flex-end!important;justify-content:center!important;padding-bottom:6px!important}
      .guli-bottom-nav-modern button span{font-size:9px!important;line-height:1!important;font-weight:800!important;letter-spacing:.1px!important;color:inherit!important;height:auto!important;margin:0!important}
      .guli-bottom-nav-modern button:after{position:absolute!important;top:2px!important;left:50%!important;transform:translateX(-50%) translateZ(0)!important;width:39px!important;height:39px!important;border-radius:14px!important;display:grid!important;place-items:center!important;font-size:24px!important;line-height:1!important;background:linear-gradient(145deg,#fff,#f7e0e7)!important;border:1px solid rgba(255,255,255,.96)!important;box-shadow:0 7px 15px rgba(75,35,45,.18),inset 0 2px 0 rgba(255,255,255,.95),inset 0 -2px 4px rgba(160,75,100,.06)!important;filter:saturate(1.12)!important;transition:transform .18s cubic-bezier(.16,1,.3,1),box-shadow .18s ease!important}
      .guli-bottom-nav-modern button:active:after{transform:translateX(-50%) scale(.9)!important}
      ...
      .guli-bottom-nav-modern button.active:before{z-index:0!important;content:""!important;position:absolute!important;top:1px!important;left:50%!important;transform:translateX(-50%)!important;width:44px!important;height:44px!important;border-radius:16px!important;background:#f9dfe5!important;box-shadow:0 5px 14px rgba(180,75,101,.13)!important}
      .guli-bottom-nav-modern button.active:after{z-index:2!important;box-shadow:0 8px 18px rgba(180,75,101,.22),inset 0 2px 0 rgba(255,255,255,.98)!important}
      .guli-bottom-nav-modern button em{font-size:9px!important;z-index:5!important;right:18%!important;top:-1px!important;min-width:17px!important;height:17px!important;padding:0 4px!important;border-radius:999px!important;background:#d94f79!important;color:#fff!important;font-style:normal!important;display:grid!important;place-items:center!important;box-shadow:0 2px 7px rgba(180,55,90,.28)!important}
    }
