(() => {
  ...
  function mount(){
    ...
    const root=document.createElement('div');root.id='guli-canonical-auth';root.innerHTML='<div class="card"><h2>GULI hisobiga kirish</h2><p>Telefon raqamingizni Telegram orqali tasdiqlang.<br>OTP kod kiritish shart emas.</p><button class="tg">📱 Telegram orqali kirish</button><div class="status">Telegram ochilgach, <b>Start</b> tugmasini bosing. Keyin <b>Telefon raqamimni yuborish</b> tugmasini bosing. Brauzer avtomatik kiradi.</div><button class="close">Yopish</button></div>';document.body.appendChild(root);
