import './lib/customerIdentityBridge.ts'
    ...
    return (
      <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 24, background: '#fff9fa', color: '#2b2024', fontFamily: 'system-ui, sans-serif' }}>
        <section style={{ width: '100%', maxWidth: 420, textAlign: 'center', background: '#fff', border: '1px solid #f0dfe3', borderRadius: 24, padding: 24, boxShadow: '0 14px 40px rgba(70,35,45,.08)' }}>
          <img src={GULI_LOGO_BASE64} alt="Guli Premium" style={{ width: 64, height: 64, borderRadius: '50%', objectFit: 'contain', padding: '4px', margin: '0 auto 10px', display: 'block', boxShadow: '0 6px 16px rgba(0,0,0,0.1)' }} />
...
if (typeof window !== 'undefined') {
  ...
  const customFetch = (input: RequestInfo | URL, init?: RequestInit) => {
    ...
    if ((url.startsWith(apiBase) || url.includes('workers.dev') || url.includes('onrender.com')) && webApp?.initData) {
