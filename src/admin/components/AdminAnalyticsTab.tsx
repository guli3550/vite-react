...
export function AdminAnalyticsTab({
  ...
  const categoryStats = [
    { name: "Penyuar", share: 32, amount: 1552000, color: "#b6536b" },
    { name: "Byusgalter", share: 28, amount: 1358000, color: "#c9687f" },
    { name: "Pijama", share: 20, amount: 970000, color: "#d88398" },
    { name: "Tursik", share: 12, amount: 582000, color: "#e89eb0" },
    { name: "Mayka", share: 8, amount: 388000, color: "#f3bac8" },
  ];
