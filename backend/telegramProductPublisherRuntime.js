...
function productUrl() {
  // Telegram product broadcasts intentionally use only the canonical
  // storefront URL. Product-specific query/deep-link parameters are disabled.
  return CANONICAL_STORE_URL + "/";
}
